...
class SecurityProfilesModel {
    ...
    public static function getPredefinedTitle( $id ) {
        switch ( $id ) {
            case self::COMMON_FOLDERS: {
                return __( "Common Folders", 'ifolders' );
            } break;
            case self::PERSONAL_FOLDERS: {
                return __( "Personal Folders", 'ifolders' );
            } break;
        }
        return null;
    }
    ...
    public static function getPredefinedDescription( $id ) {
        switch ( $id ) {
            case self::COMMON_FOLDERS: {
                return __( "Users can create, view, and edit each other's folders if they are granted such access.", 'ifolders' );
            } break;
            case self::PERSONAL_FOLDERS: {
                return __( "Users can only create, view and edit their personal folders if they are granted such access.", 'ifolders' );
            } break;
        }
        return null;
    }
