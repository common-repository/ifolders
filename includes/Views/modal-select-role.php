...
<div class="ifs-modal">
    <div class="ifs-dialog">
        <div class="ifs-header">
            <div class="ifs-title"><?php esc_html_e("Select Role", 'ifolders'); ?></div>
        ...
        <div class="ifs-data">
            ...
            <p><?php esc_html_e("To create a new profile entry, select a registered WordPress role from the list below.", 'ifolders'); ?></p>
