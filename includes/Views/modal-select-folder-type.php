...
<div class="ifs-modal">
    <div class="ifs-dialog">
        <div class="ifs-header">
            <div class="ifs-title"><?php esc_html_e('Select Folder Type', 'ifolders'); ?></div>
        ...
        <div class="ifs-data">
            ...
            <p><?php esc_html_e('Select a registered built-in or custom WordPress post type from the list below if you want to create a new folder type item.', 'ifolders'); ?></p>
        ...
        <div class="ifs-footer">
            ...
            <div class="ifs-btn ifs-submit" al-on.click="Modal.fn.submit()" al-if="Modal.data.selected"><?php esc_html_e('Select', 'ifolders'); ?></div>
        </div>
    </div>
</div>