...
use iFolders\Models\FolderTypesModel;
...
class Installer {
    ...
    private function init() {
        ...
        if ( version_compare( get_option( 'ifolders_version' ), IFOLDERS_PLUGIN_VERSION, '<' ) ) {
            self::updateVersion();
        }
        ...
        if ( version_compare( get_option( 'ifolders_db_version' ), IFOLDERS_PLUGIN_DB_VERSION, '<' ) ) {
    ...
    private function updateVersion() {
        update_option( 'ifolders_version', IFOLDERS_PLUGIN_VERSION );
    }
    ...
    private function updateDbVersion() {
        update_option( 'ifolders_db_version', IFOLDERS_PLUGIN_DB_VERSION );
    }
}